...
<div class="x-body">
    ...
    <table class="layui-table x-admin">
        ...
        <tr>
            ...
            <td>2017-01-01 11:11:42</td>
            <td class="td-manage">
                <a title="编辑"  onclick="x_admin_show('编辑顾客','customer-edit.jsp',800,500)" href="javascript:;">
        ...
        <tr>
            ...
            <td>2017-01-01 11:11:42</td>
            <td class="td-manage">
                <a title="编辑"  onclick="x_admin_show('编辑顾客','customer-edit.jsp',600,400)" href="javascript:;">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" onclick="member_del(this,'要删除的id')" href="javascript:;">
                    <i class="layui-icon">&#xe640;</i>
