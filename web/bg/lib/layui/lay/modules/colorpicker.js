...
;layui.define("jquery", function (e) {
    ...
    var i = layui.jquery, o = {
        ...
        b = "layui-colorpicker-basis-cursor", m = "layui-colorpicker-main-input", k = function (e) {
    ...
    D.prototype.config = {
        ...
        var e = this, i = (e.config, e.elemColorBox.find("." + f)), o = e.elemPicker.find("." + m), r = i[0],
        ...
        var e = this, o = e.config, r = e.elemColorBox.find("." + f), t = r.attr("lay-type"),
            ...
            y = e.elemPicker.find("." + b), C = e.elemPicker.find("." + v), w = e.elemPicker.find("." + h),
            ...
            L = function (i, n, l, c) {
                e.select(i, n, l);
                var f = x({h: i, s: n, b: l});
                if (j.addClass(a).removeClass(s), r[0].style.background = "rgb(" + f.r + ", " + f.g + ", " + f.b + ")", "torgb" === t && e.elemPicker.find("." + m).find("input").val("rgb(" + f.r + ", " + f.g + ", " + f.b + ")"), "rgba" === t) {
                    var d = 0;
                    d = 280 * c, w.css("left", d), e.elemPicker.find("." + m).find("input").val("rgba(" + f.r + ", " + f.g + ", " + f.b + ", " + c + ")"), r[0].style.background = "rgba(" + f.r + ", " + f.g + ", " + f.b + ", " + c + ")", C[0].style.background = "linear-gradient(to right, rgba(" + f.r + ", " + f.g + ", " + f.b + ", 0), rgb(" + f.r + ", " + f.g + ", " + f.b + "))"
                }
                o.change && o.change(e.elemPicker.find("." + m).find("input").val())
        ...
        l.on("mousedown", function (e) {
            ...
            E = n, H = t, L(D, t, n, W), e.preventDefault()
        ...
        t.elemPicker.find("." + p).css("top", c), t.elemPicker.find("." + g)[0].style.background = "#" + n, t.elemPicker.find("." + b).css({
            top: a,
            left: s
        }), "change" !== r && t.elemPicker.find("." + m).find("input").val("#" + l)
    }, D.prototype.pickerEvents = function () {
        var e = this, o = e.config, r = e.elemColorBox.find("." + f), t = e.elemPicker.find("." + m + " input"), n = {
            clear: function (i) {
