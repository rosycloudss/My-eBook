...
<div class="x-body">
    <form class="layui-form">
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="" name="email" disabled="disabled" required="" lay-verify="email"
        ...
        <div class="layui-form-item">
            <label for="" class="layui-form-label">
                <span class="x-red">*</span>登陆次数
            </label>
            <div class="layui-input-inline">
                <input type="text" id=""  disabled="disabled" name="email" required="" lay-verify="email"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
